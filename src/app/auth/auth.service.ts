...
//when the function is called in the html file, uid is undefined
//when isAuthenticated is called in html, then it is back to the same issue discussed on line 72+
//there is also an issue.. for some reason... where a for loop is running and crashes the website
//it could have something to do with checking if the user is authenticated, a bunch of times

//isAdminAuthenticated runs when isAuthenticated is called in the html
